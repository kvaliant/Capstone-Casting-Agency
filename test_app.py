...
class CapstoneTestCase(unittest.TestCase):
    ...
    def test_post_actor(self):
        res = self.client().post('/actors', headers={'\
            Authorization': f'Bearer {executive_producer}'}, json={"\
                name": "test", "age": 1, "gender": "male"})
        data = json.loads(res.data)
    ...
    def test_post_movie(self):
        res = self.client().post('/movies', headers={'\
            Authorization': f'Bearer {executive_producer}'}, json={"\
                title": "test", "release_date": "2021-11-11"})
        data = json.loads(res.data)
    ...
    def test_patch_actor(self):
        ...
        self.actor.insert()
        res = self.client().patch(f'/actors/{self.actor.id}', headers={'\
            Authorization': f'Bearer {executive_producer}'}, json={"\
                name": "test1"})
        data = json.loads(res.data)
    ...
    def test_error_patch_actor(self):
        res = self.client().patch('/actors/999', headers={'\
            Authorization': f'Bearer {executive_producer}'}, json={"\
                name": "test1"})
        data = json.loads(res.data)
    ...
    def test_patch_movie(self):
        ...
        self.movie.insert()
        res = self.client().patch(f'/movies/{self.movie.id}', headers={'\
            Authorization': f'Bearer {executive_producer}'}, json={"\
                title": "test1"})
        data = json.loads(res.data)
    ...
    def test_error_patch_movie(self):
        res = self.client().patch('/movies/999', headers={'\
            Authorization': f'Bearer {executive_producer}'}, json={"\
                title": "test1"})
        data = json.loads(res.data)
    ...
    def test_delete_actor(self):
        self.actor = Actor(name="test", age=1, gender="male")
        self.actor.insert()
        res = self.client().delete(f'/actors/{self.actor.id}', headers={'\
            Authorization': f'Bearer {executive_producer}'})
        data = json.loads(res.data)
    ...
    def test_delete_movie(self):
        self.movie = Movie(title="test", release_date="2021-11-11")
        self.movie.insert()
        res = self.client().delete(f'/movies/{self.movie.id}', headers={'\
            Authorization': f'Bearer {executive_producer}'})
        data = json.loads(res.data)
...
# add actor
    def test_error_casting_assistant(self):
        res = self.client().post('/actors', headers={'\
            Authorization': f'Bearer {casting_assistant}'}, json={"\
                name": "test", "age": 1, "gender": "male"})
        data = json.loads(res.data)
...
# add actor
    def test_casting_director(self):
        res = self.client().post('/actors', headers={'\
            Authorization': f'Bearer {casting_director}'}, json={"\
                name": "test", "age": 1, "gender": "male"})
        data = json.loads(res.data)
...
# delete movie
    def test_executive_producer_2(self):
        self.movie = Movie(title="test", release_date="2021-11-11")
        self.movie.insert()
        res = self.client().delete(f'\
            /movies/{self.movie.id}', headers={'\
                Authorization': f'Bearer {executive_producer}'})
        data = json.loads(res.data)
